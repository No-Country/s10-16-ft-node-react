...
export const LayoutAuth = () => {
  return (
    <section className="bg-background font-Raleway">
      <div className="max-w-screen-2xl min-h-screen mx-auto flex gap-10 items-stretch p-6 sm:p-14">
        <Outlet/>

        <div className="lg:flex w-2/5 hidden bg-login-background bg-no-repeat bg-cover bg-center rounded-3xl relative items-center">
