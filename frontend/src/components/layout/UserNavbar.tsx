      ...
      <div className="flex items-center relative">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
          ...
          <g filter="url(#filter0_d_3135_38768)">
            <path fillRule="evenodd" clipRule="evenodd" d="M9.61084 21.6167C10.7387 21.7953 11.8796 21.8833 13.0205 21.8833C14.1472 21.8833 15.2738 21.7975 16.3879 21.6246C16.0491 23.1352 14.6611 24.2666 13.0002 24.2666C11.3365 24.2666 9.94653 23.1313 9.61084 21.6167Z" fill="#F59426"/>
          </g>
          ...
          <defs>
            <filter id="filter0_d_3135_38768" x="0.61084" y="18.6167" width="24.7771" height="20.65" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
