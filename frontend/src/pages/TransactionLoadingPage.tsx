  ...
  return (
    <div className="flex flex-col w-screen h-screen">
      ...
      <div className="w-full md:w-[552px] h-[314px] flex flex-col justify-center items-center gap-10 mx-auto mt-20">
        <h3 className="text-center w-full md:w-[356px] text-4xl  font-bold font-Raleway">Transacción en proceso</h3>
        <p className="text-center text-xl  font-Poppins">Ayudando proyectos increibles</p>
